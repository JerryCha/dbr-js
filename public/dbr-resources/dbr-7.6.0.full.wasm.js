...
var ca = "./this.program", da = !1, ea = !1, fa = !1, ha = !1;
...
var h = "", ia, ja, ka, la;
if (fa) {
  h = ea ? require("path").dirname(h) + "/" : __dirname + "/", ia = function(a, b) {
    ka || (ka = require("fs"));
    la || (la = require("path"));
    a = la.normalize(a);
  ...
  if (ha) {
    "undefined" != typeof read && (ia = function(a) {
      return read(a);
    }), ja = function(a) {
    ...
    if (da || ea) {
      ea ? h = self.location.href : document.currentScript && (h = document.currentScript.src), h = 0 !== h.indexOf("blob:") ? h.substr(0, h.lastIndexOf("/") + 1) : "", ia = function(a) {
...
var ma = c.print || console.log.bind(console), u = c.printErr || console.warn.bind(console);
for (ba in aa) {
...
var qa, ra = new WebAssembly.Table({initial:8217, maximum:8217, element:"anyfunc"}), sa = !1;
function assert(a, b) {
...
function za(a, b) {
  ...
  d <<= 1;
  if (32 < d - a && ya) {
    return ya.decode(A.subarray(a, d));
  }
  d = 0;
  for (e = "";;) {
    var g = Ba[a + 2 * d >> 1];
...
c.wasmMemory ? qa = c.wasmMemory : qa = new WebAssembly.Memory({initial:Oa / 65536, maximum:32768});
qa && (Ka = qa.buffer);
Oa = Ka.byteLength;
assert(0 === Oa % 65536);
assert(!0);
...
var cb = Math.abs, db = Math.ceil, eb = Math.floor, fb = Math.min, gb = 0, hb = null, ib = null, jb = {};
function kb() {
  gb++;
...
function sb() {
  return pa || !da && !ea || "function" !== typeof fetch || nb("file://") ? new Promise(function(a) {
    ...
    if (!a.ok) {
      throw "failed to load wasm binary file at '" + ob + "'";
    }
...
var Db = {open:function(a) {
  ...
  null === b || 10 === b ? (u(ua(a.output, 0)), a.output = []) : 0 != b && a.output.push(b);
}, flush:function(a) {
  a.output && 0 < a.output.length && (u(ua(a.output, 0)), a.output = []);
}}, K = {B:null, F:function() {
...
133:"Attempting to exec a shared library", 135:"Streams pipe error", 136:"Too many users", 137:"Socket type not supported", 138:"Not supported", 139:"Protocol family not supported", 140:"Can't send after socket shutdown", 141:"Too many references", 142:"Host is down", 148:"No medium (in tape drive)", 156:"Level 2 not synchronized"}, Mb = {Ic:63, hc:44, Vc:71, Db:27, Fb:29, Ec:60, Ra:1, ic:45, $a:8, jb:12, Xa:6, ed:6, mc:48, Sa:2, wb:21, vc:105, hb:10, vb:20, gd:75, fc:43, xc:54, Hb:31, Eb:28, ac:41, 
Tb:33, Cc:59, bd:74, xb:22, rc:51, Uc:70, Rc:69, Ub:34, Kc:64, sb:18, Oc:68, nc:49, Ab:24, kb:106, Jb:156, Kb:107, Lb:108, Rb:109, cd:110, dc:111, Ib:112, pb:16, jc:46, Za:113, cb:114, hd:115, bc:104, eb:103, fb:102, qb:16, gb:101, tc:100, ec:116, Zc:117, sc:118, oc:119, pc:120, Qc:121, kc:47, Va:122, Wc:123, lb:124, Lc:65, Wb:36, tb:125, bb:9, Dc:126, ab:127, Pc:128, Mb:129, Nb:130, Qb:131, Pb:132, Ob:133, uc:52, yc:55, Xb:37, Sb:32, Fc:138, Jc:139, ob:15, cc:42, Wa:5, Nc:67, Ac:57, qc:50, Sc:140, 
nb:14, Ta:3, mb:13, $b:40, Yb:38, $c:73, yb:142, zb:23, Cb:26, Ya:7, rb:17, Vb:35, Mc:66, Tc:137, Ua:4, Zb:39, Gb:30, wc:53, ad:141, dd:136, ub:19, Xc:72, Bc:138, lc:148, Bb:25, Gc:61, ib:11, zc:56, Hc:62, Yc:135}, Nb = null, Ob = {}, Pb = [], Qb = 1, Rb = null, Sb = !0, M = {}, J = null, Jb = {};
function N(a, b) {
  a = zb("/", a);
  b = b || {};
  if (!a) {
  ...
  for (e = 0; e < a.length; e++) {
    ...
    if (!f || b.fa) {
      for (f = 0; 40960 === (g.mode & 61440);) {
        if (g = Tb(d), d = zb(xb(d), g), g = N(d, {ia:b.ia}).node, 40 < f++) {
          throw new J(32);
        }
      }
    }
...
function Kb(a, b) {
  var d;
  if (d = (d = Xb(a, "x")) ? d : a.f.lookup ? 0 : 2) {
    throw new J(d, a);
  }
...
var Zb = {r:0, rs:1052672, "r+":2, w:577, wx:705, xw:705, "w+":578, "wx+":706, "xw+":706, a:1089, ax:1217, xa:1217, "a+":1090, "ax+":1218, "xa+":1218};
function $b(a) {
  var b = ["r", "w", "rw"][a & 3];
  a & 512 && (b += "w");
  return b;
...
function kc(a, b, d, e) {
  ...
  if (!g && (d = f ? 40960 === (f.mode & 61440) ? 32 : L(f.mode) && ("r" !== $b(b) || b & 512) ? 31 : Xb(f, $b(b)) : 44)) {
    throw new J(d);
  }
  if (b & 512) {
    d = f;
    var k;
    "string" === typeof d ? k = N(d, {fa:!0}).node : k = d;
    if (!k.f.C) {
      throw new J(63);
    }
    if (L(k.mode)) {
  ...
  b &= -131713;
  e = dc({node:f, path:Ub(f), flags:b, seekable:!0, position:0, g:f.g, Qa:[], error:!1}, e);
  e.g.open && e.g.open(e);
  !c.logReadFiles || b & 1 || (lc || (lc = {}), a in lc || (lc[a] = 1, u("FS.trackingDelegate error on read file: " + a)));
  try {
...
function nc() {
  J || (J = function(a, b) {
    ...
    this.Ka(a);
    this.message = Lb[a];
    this.stack && (Object.defineProperty(this, "stack", {value:Error().stack, writable:!0}), this.stack = mb(this.stack));
...
function Hc(a) {
  return {count:a.count, O:a.O, U:a.U, i:a.i, l:a.l, u:a.u, v:a.v};
}
function Ic(a) {
...
function Wc(a, b) {
  if (null === b) {
    return this.ga && S("null is not a valid " + this.name), 0;
  }
...
function Yc(a, b) {
  ...
  if (this.Z) {
    switch(void 0 === b.b.u && S("Passing raw pointer to smart pointer is illegal"), this.La) {
      case 0:
...
function fd(a, b) {
  ...
  b.count = {value:1};
  return Mc(Object.create(a, {b:{value:b}}));
}
function V(a, b, d, e) {
  this.name = a;
  this.h = b;
...
var qd = [], Y = [{}, {value:void 0}, {value:null}, {value:!0}, {value:!1}];
function rd(a) {
    ...
    if (37 == f) {
      ...
      switch(String.fromCharCode(k)) {
        ...
        case "p":
          ...
          m = "";
          if (100 == k || 105 == k) {
            var v = bb(f, 8 * x, 1).toString(10);
          } else {
            if (117 == k) {
              v = ab(f, 8 * x, 1).toString(10), f = Math.abs(f);
            } else {
              if (111 == k) {
                v = (n ? "0" : "") + C.toString(8);
              } else {
                if (120 == k || 88 == k) {
                  ...
                  112 == k && (0 === C ? v = "(nil)" : (m = "0x", v = C.toString(16)));
                }
              }
            }
          }
        ...
        case "G":
          ...
          if (isNaN(f)) {
            ...
            if (isFinite(f)) {
              ...
              x = Math.min(t, 20);
              if (103 == k || 71 == k) {
                l = !0, t = t || 1, x = parseInt(f.toExponential(x).split("e")[1], 10), t > x && -4 <= x ? (k = (103 == k ? "f" : "F").charCodeAt(0), t -= x + 1) : (k = (103 == k ? "e" : "E").charCodeAt(0), t--), x = Math.min(t, 20);
              }
              if (101 == k || 69 == k) {
                v = f.toExponential(x), /[eE][-+]\d$/.test(v) && (v = v.slice(0, -1) + "0" + v.slice(-1));
              } else {
                if (102 == k || 70 == k) {
                  v = f.toFixed(x), 0 === f && (0 > f || 0 === f && -Infinity === 1 / f) && (v = "-" + v);
                }
              }
              m = v.split("e");
              if (l && !n) {
        ...
        case "s":
          ...
          if (q) {
            ...
            g = g.concat(Eb("(null)".substr(0, p), !0));
          }
          if (b) {
            for (; p < w--;) {
              g.push(32);
...
function zd(a) {
  ...
  var d = null;
  if (a & 128) {
    for (d = yd(arguments); 0 <= d[1].indexOf("_emscripten_");) {
      d = yd(d[0]);
    }
  }
  var e = b.split("\n");
  b = "";
  var g = /\s*(.*?)@(.*?):([0-9]+):([0-9]+)/, f = /\s*(.*?)@(.*):(.*)(:(.*))?/, k = /\s*at (.*?) \((.*):(.*):(.*)\)/, m;
  for (m in e) {
    var q = e[m], n;
    if ((n = k.exec(q)) && 5 == n.length) {
      ...
      if ((n = g.exec(q)) || (n = f.exec(q)), n && 4 <= n.length) {
        q = n[1], p = n[2], z = n[3], n = n[4] | 0;
      } else {
        b += q + "\n";
        continue;
      }
    ...
    var l = !1;
    if (a & 8) {
      var t = emscripten_source_map.pd({line:z, wa:n});
      if (l = t && t.source) {
        a & 64 && (t.source = t.source.substring(t.source.replace(/\\/g, "/").lastIndexOf("/") + 1)), b += "    at " + w + " (" + t.source + ":" + t.line + ":" + t.wa + ")\n";
      }
    }
    if (a & 16 || !l) {
      a & 64 && (p = p.substring(p.replace(/\\/g, "/").lastIndexOf("/") + 1)), b += (l ? "     = " + q : "    at " + w) + " (" + p + ":" + z + ":" + n + ")\n";
    }
...
function Z(a) {
  ...
  var b = xa(a);
  if (!Z.I || Z.I < b + 1) {
    Z.I && X(Z.buffer), Z.I = b + 1, Z.buffer = Ia(Z.I);
  }
  wa(a, Z.buffer, Z.I);
  return Z.buffer;
}
...
function Dd() {
  ...
  if (!Ed) {
    Ed = !0;
    B[Fd() >> 2] = 60 * (new Date).getTimezoneOffset();
    var b = (new Date).getFullYear(), d = new Date(b, 0, 1);
    b = new Date(b, 6, 1);
    B[Gd() >> 2] = Number(d.getTimezoneOffset() != b.getTimezoneOffset());
    var e = a(d), g = a(b);
    e = Ha(e);
    g = Ha(g);
    b.getTimezoneOffset() < d.getTimezoneOffset() ? (B[Hd() >> 2] = e, B[Hd() + 4 >> 2] = g) : (B[Hd() >> 2] = g, B[Hd() + 4 >> 2] = e);
  }
}
var Ed;
function Id(a) {
...
var Kd = [31, 29, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31], Ld = [31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31];
function Md(a, b) {
  for (a = new Date(a.getTime()); 0 < b;) {
    var d = a.getMonth(), e = (Id(a.getFullYear()) ? Kd : Ld)[d];
    if (b > e - a.getDate()) {
...
function Nd(a, b, d, e) {
  ...
  function k(l, t) {
    ...
    var C;
    0 === (C = x(l.getFullYear() - t.getFullYear())) && 0 === (C = x(l.getMonth() - t.getMonth())) && (C = x(l.getDate() - t.getDate()));
    return C;
  }
  function m(l) {
    switch(l.getDay()) {
  ...
  function q(l) {
    l = Md(new Date(l.s + 1900, 0, 1), l.ea);
    var t = new Date(l.getFullYear() + 1, 0, 4), x = m(new Date(l.getFullYear(), 0, 4));
    t = m(t);
    return 0 >= k(x, l) ? 0 >= k(t, l) ? l.getFullYear() + 1 : l.getFullYear() : l.getFullYear() - 1;
  }
  var n = B[e + 40 >> 2];
  e = {Oa:B[e >> 2], Na:B[e + 4 >> 2], ba:B[e + 8 >> 2], V:B[e + 12 >> 2], T:B[e + 16 >> 2], s:B[e + 20 >> 2], da:B[e + 24 >> 2], ea:B[e + 28 >> 2], rd:B[e + 32 >> 2], Ma:B[e + 36 >> 2], Pa:n ? y(n) : ""};
  d = y(d);
  n = {"%c":"%a %b %d %H:%M:%S %Y", "%D":"%m/%d/%y", "%F":"%Y-%m-%d", "%h":"%b", "%r":"%I:%M:%S %p", "%R":"%H:%M", "%T":"%H:%M:%S", "%x":"%m/%d/%y", "%X":"%H:%M:%S", "%Ec":"%c", "%EC":"%C", "%Ex":"%m/%d/%y", "%EX":"%H:%M:%S", "%Ey":"%y", "%EY":"%Y", "%Od":"%d", "%Oe":"%e", "%OH":"%H", "%OI":"%I", "%Om":"%m", "%OM":"%M", "%OS":"%S", "%Ou":"%u", "%OU":"%U", "%OV":"%V", "%Ow":"%w", "%OW":"%W", "%Oy":"%y"};
  for (var p in n) {
    d = d.replace(new RegExp(p, "g"), n[p]);
  }
  var z = "Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "), w = "January February March April May June July August September October November December".split(" ");
  n = {"%a":function(l) {
    ...
    return f(l.V + Jd(Id(l.s + 1900) ? Kd : Ld, l.T - 1), 3);
  }, "%m":function(l) {
    return f(l.T + 1, 2);
  }, "%M":function(l) {
    return f(l.Na, 2);
    ...
    var t = new Date(l.s + 1900, 0, 1), x = 0 === t.getDay() ? t : Md(t, 7 - t.getDay());
    l = new Date(l.s + 1900, l.T, l.V);
    return 0 > k(x, l) ? f(Math.ceil((31 - x.getDate() + (Jd(Id(l.getFullYear()) ? Kd : Ld, l.getMonth() - 1) - 31) + l.getDate()) / 7), 2) : 0 === k(x, t) ? "01" : "00";
  }, "%V":function(l) {
    var t = new Date(l.s + 1901, 0, 4), x = m(new Date(l.s + 1900, 0, 4));
    t = m(t);
    var C = Md(new Date(l.s + 1900, 0, 1), l.ea);
    return 0 > k(C, x) ? "53" : 0 >= k(t, C) ? "01" : f(Math.ceil((x.getFullYear() < l.s + 1900 ? l.ea + 32 - x.getDate() : l.ea + 1 - x.getDate()) / 7), 2);
  }, "%w":function(l) {
    return l.da;
  }, "%W":function(l) {
    var t = new Date(l.s, 0, 1), x = 1 === t.getDay() ? t : Md(t, 0 === t.getDay() ? 1 : 7 - t.getDay() + 1);
    l = new Date(l.s + 1900, l.T, l.V);
    return 0 > k(x, l) ? f(Math.ceil((31 - x.getDate() + (Jd(Id(l.getFullYear()) ? Kd : Ld, l.getMonth() - 1) - 31) + l.getDate()) / 7), 2) : 0 === k(x, t) ? "01" : "00";
  }, "%y":function(l) {
...
Qc.prototype.isAliasOf = function(a) {
  if (!(this instanceof Qc && a instanceof Qc)) {
    return !1;
  }
...
Qc.prototype.clone = function() {
  ...
  var a = Mc(Object.create(Object.getPrototypeOf(this), {b:{value:Hc(this.b)}}));
  a.b.count.value += 1;
  a.b.O = !1;
  return a;
};
...
V.prototype.fromWireType = function(a) {
  function b() {
    return this.Z ? fd(this.h.H, {l:this.Fa, i:d, v:this, u:a}) : fd(this.h.H, {l:this, i:a});
  }
  var d = this.Ba(a);
  if (!d) {
  ...
  return null === g ? b.call(this) : this.Z ? fd(e.h.H, {l:e, i:g, v:this, u:a}) : fd(e.h.H, {l:e, i:g});
};
...
var Rd = {__assert_fail:function(a, b, d, e) {
  ...
  try {
    ...
    for (var k = mc(e, 0, 1), m = Math.floor(k / 280); m < e.K.length && a + 280 <= d;) {
      ...
      I = [n >>> 0, (H = n, 1.0 <= +cb(H) ? 0.0 < H ? (fb(+eb(H / 4294967296.0), 4294967295.0) | 0) >>> 0 : ~~+db((H - +(~~H >>> 0)) / 4294967296.0) >>> 0 : 0)];
      B[b + a >> 2] = I[0];
      B[b + a + 4 >> 2] = I[1];
      I = [280 * (m + 1) >>> 0, (H = 280 * (m + 1), 1.0 <= +cb(H) ? 0.0 < H ? (fb(+eb(H / 4294967296.0), 4294967295.0) | 0) >>> 0 : ~~+db((H - +(~~H >>> 0)) / 4294967296.0) >>> 0 : 0)];
      B[b + a + 8 >> 2] = I[0];
      B[b + a + 12 >> 2] = I[1];
      Ba[b + a + 16 >> 1] = 280;
      D[b + a + 18 >> 0] = p;
  ...
  try {
    if (-1 === (a | 0) || 0 === b) {
      ...
      if (e && b === e.md) {
        var g = Pb[e.fd];
        if (e.qd & 2) {
          var f = e.flags, k = e.offset, m = A.slice(a, a + b);
  ...
  try {
    ...
    if (0 >= d) {
      ...
      var g = Tb(a), f = Math.min(d, xa(g)), k = D[b + f];
      wa(g, b, d + 1);
      D[b + f] = k;
      e = f;
    }
  ...
  try {
    a = y(a);
    var b = N(a, {parent:!0}).node, d = yb(a), e = Kb(b, d), g = bc(b, d, !0);
    if (g) {
      throw new J(g);
    }
    if (!b.f.rmdir) {
  ...
  try {
    a = y(a);
    var b = N(a, {parent:!0}).node, d = yb(a), e = Kb(b, d), g = bc(b, d, !1);
    if (g) {
      throw new J(g);
    }
    if (!b.f.unlink) {
  ...
  T([a, b, d], e ? [e] : [], function(t) {
    ...
    t = Cc(l, function() {
      if (Object.getPrototypeOf(this) !== v) {
        throw new Ec("Use 'new' to construct " + p);
      }
      if (void 0 === F.J) {
        throw new Ec(p + " has no accessible constructor");
      }
      var bd = F.J[arguments.length];
      if (void 0 === bd) {
        throw new Ec("Tried to invoke ctor of " + p + " with invalid number of parameters (" + arguments.length + ") - expected (" + Object.keys(F.J).toString() + ") parameters instead!");
      }
      return bd.apply(this, arguments);
    });
    var v = Object.create(C, {constructor:{value:t}});
    t.prototype = v;
    var F = new Uc(p, t, v, w, x, f, m, n);
    x = new V(p, F, !0, !1);
    C = new V(p + "*", F, !1, !1);
    var P = new V(p + " const*", F, !1, !0);
    Rc[a] = {pointerType:C, ya:P};
    gd(l, t);
    return [x, C, P];
  });
  ...
  T([], [a], function(q) {
    ...
    q = q[0];
    var p = q.name + "." + b, z = q.h.constructor;
  ...
  T([], [a], function(n) {
    ...
    void 0 === n.h.J && (n.h.J = []);
    if (void 0 !== n.h.J[b - 1]) {
      throw new Ec("Cannot register multiple constructors with identical number of parameters (" + (b - 1) + ") for class '" + n.name + "'! Overload resolution is currently only performed using the parameter count, not actual type info!");
    }
    n.h.J[b - 1] = function() {
  ...
  T([], [a], function(n) {
    ...
    T([], q, function(t) {
      t = nd(z, t, n, f, k);
      void 0 === w[b].o ? (t.N = d - 2, w[b] = t) : w[b].o[d - 2] = t;
      return [];
    });
    return [];
  });
  ...
  T([], [a], function(p) {
    ...
    T([], q ? [d, k] : [d], function(l) {
      var t = l[0], x = {get:function() {
        var v = pd(this, p, z + " getter");
        return t.fromWireType(g(f, v));
      }, enumerable:!0};
      if (q) {
        q = W(m, q);
        var C = l[1];
        x.set = function(v) {
          var F = pd(this, p, z + " setter"), P = [];
  ...
  U(a, {name:b, fromWireType:function(d) {
    ...
    return Zc(e);
  }, argPackAdvance:8, readValueFromPointer:ad, D:null});
  ...
  U(a, {name:b, fromWireType:function(e) {
    ...
    if ("number" !== typeof g && "boolean" !== typeof g) {
      throw new TypeError('Cannot convert "' + Xc(g) + '" to ' + this.name);
    }
    return g;
  }, argPackAdvance:8, readValueFromPointer:sd(b, d), D:null});
  ...
  U(a, {name:b, fromWireType:f, toWireType:function(n, p) {
    if ("number" !== typeof p && "boolean" !== typeof p) {
      throw new TypeError('Cannot convert "' + Xc(p) + '" to ' + this.name);
    }
    if (p < e || p > g) {
      throw new TypeError('Passing a number "' + Xc(p) + '" from JS side to C/C++ side to an argument of type "' + b + '", which is outside the valid range [' + e + ", " + g + "]!");
    }
    return q ? p >>> 0 : p | 0;
  }, argPackAdvance:8, readValueFromPointer:td(b, k, 0 !== e), D:null});
  ...
  d = R(d);
  U(a, {name:d, fromWireType:e, argPackAdvance:8, readValueFromPointer:e}, {Ca:!0});
  ...
  U(a, {name:b, fromWireType:function(e) {
    ...
    null !== e && e.push(X, m);
    return m;
  }, argPackAdvance:8, readValueFromPointer:ad, D:function(e) {
    X(e);
  }});
  ...
  if (2 === b) {
    ...
    4 === b && (e = Ea, g = Fa, f = Ga, k = function() {
      return E;
    }, m = 2);
  }
  U(a, {name:d, fromWireType:function(q) {
    for (var n = E[q >> 2], p = k(), z, w = q + 4, l = 0; l <= n; ++l) {
      var t = q + 4 + l * b;
      if (0 == p[t >> m] || l == n) {
        w = e(w, t - w), void 0 === z ? z = w : (z += String.fromCharCode(0), z += w), w = t + b;
      }
    }
    X(q);
    return z;
    ...
    var p = f(n), z = Ia(4 + p + b);
    E[z >> 2] = p >> m;
    g(n, z + 4, p + b);
    null !== q && q.push(X, z);
    return z;
  }, argPackAdvance:8, readValueFromPointer:ad, D:function(q) {
    X(q);
  }});
}, _embind_register_void:function(a, b) {
  b = R(b);
  U(a, {ld:!0, name:b, argPackAdvance:0, fromWireType:function() {
  }, toWireType:function() {
  }});
}, _emval_decref:rd, _emval_incref:function(a) {
  4 < a && (Y[a].ja += 1);
  ...
  r();
}, clock:ud, emscripten_get_sbrk_ptr:function() {
  return 1850080;
  ...
  a & 1 ? a & 4 ? console.error(e) : a & 2 ? console.warn(e) : a & 512 ? console.info(e) : a & 256 ? console.debug(e) : console.log(e) : a & 6 ? u(e) : ma(e);
  ...
  return eval(y(a)) | 0;
}, emscripten_run_script_string:Z, environ_get:function(a, b) {
  var d = 0;
  ...
  try {
    a: {
      for (var g = vc(a), f = a = 0; f < d; f++) {
        var k = B[b + (8 * f + 4) >> 2], m = g, q = B[b + 8 * f >> 2], n = k, p = void 0, z = D;
        if (0 > n || 0 > p) {
          throw new J(28);
        }
        if (null === m.fd) {
  ...
  try {
    ...
    mc(f, a, e);
    I = [f.position >>> 0, (H = f.position, 1.0 <= +cb(H) ? 0.0 < H ? (fb(+eb(H / 4294967296.0), 4294967295.0) | 0) >>> 0 : ~~+db((H - +(~~H >>> 0)) / 4294967296.0) >>> 0 : 0)];
    B[g >> 2] = I[0];
    B[g + 4 >> 2] = I[1];
  ...
  try {
    a: {
      for (var g = vc(a), f = a = 0; f < d; f++) {
        var k = g, m = B[b + 8 * f >> 2], q = B[b + (8 * f + 4) >> 2], n = void 0, p = D;
        if (0 > q || 0 > n) {
          throw new J(28);
        }
        if (null === k.fd) {
        ...
        try {
          ...
          u("FS.trackingDelegate['onWriteToFile']('" + k.path + "') threw an exception: " + x.message);
        }
        var l = w;
        if (0 > l) {
          var t = -1;
  ...
  B[462524] = a.getSeconds();
  B[462525] = a.getMinutes();
  B[462526] = a.getHours();
  B[462527] = a.getDate();
  B[462528] = a.getMonth();
  B[462529] = a.getFullYear() - 1900;
  B[462530] = a.getDay();
  var b = new Date(a.getFullYear(), 0, 1);
  B[462531] = (a.getTime() - b.getTime()) / 864E5 | 0;
  B[462533] = -(60 * a.getTimezoneOffset());
  ...
  B[462534] = a;
  return 1850096;
}, memory:qa, mktime:function(a) {
  Dd();
  var b = new Date(B[a + 20 >> 2] + 1900, B[a + 16 >> 2], B[a + 12 >> 2], B[a + 8 >> 2], B[a + 4 >> 2], B[a >> 2], 0), d = B[a + 32 >> 2], e = b.getTimezoneOffset(), g = new Date(b.getFullYear(), 0, 1), f = (new Date(b.getFullYear(), 6, 1)).getTimezoneOffset(), k = g.getTimezoneOffset(), m = Math.min(k, f);
  0 > d ? B[a + 32 >> 2] = Number(f != k && m == e) : 0 < d != (m == e) && (f = Math.max(k, f), b.setTime(b.getTime() + 60000 * ((0 < d ? m : f) - e)));
  B[a + 24 >> 2] = b.getDay();
...
}, strftime:Nd, strftime_l:function(a, b, d, e) {
  return Nd(a, b, d, e);
}, table:ra, time:function(a) {
...
(function() {
  ...
  var e = {env:Rd, wasi_snapshot_preview1:Rd};
  kb();
  var g = c;
  ...
  (function() {
    if (pa || "function" !== typeof WebAssembly.instantiateStreaming || pb() || nb("file://") || "function" !== typeof fetch) {
      return d(b);
    }
...
var tb = c.___wasm_call_ctors = G("__wasm_call_ctors"), xd = c._strlen = G("strlen"), Ia = c._malloc = G("malloc"), X = c._free = G("free"), Qd = c.___errno_location = G("__errno_location");
c._fflush = G("fflush");
...
var Hd = c.__get_tzname = G("_get_tzname"), Gd = c.__get_daylight = G("_get_daylight"), Fd = c.__get_timezone = G("_get_timezone");
  ...
  function a() {
    if (!Sd && (Sd = !0, c.calledRun = !0, !sa)) {
      ...
      if (!c.noFSInit && !oc) {
        ...
        var b = kc("/dev/stdin", "r"), d = kc("/dev/stdout", "w"), e = kc("/dev/stderr", "w");

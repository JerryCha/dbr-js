...
var qa, ra = new WebAssembly.Table({initial:3703, maximum:3703, element:"anyfunc"}), sa = !1;
function assert(a, b) {
...
var Rd = {__assert_fail:function(a, b, d, e) {
  ...
  B[258944] = a.getSeconds();
  B[258945] = a.getMinutes();
  B[258946] = a.getHours();
  B[258947] = a.getDate();
  B[258948] = a.getMonth();
  B[258949] = a.getFullYear() - 1900;
  B[258950] = a.getDay();
  var b = new Date(a.getFullYear(), 0, 1);
  B[258951] = (a.getTime() - b.getTime()) / 864E5 | 0;
  B[258953] = -(60 * a.getTimezoneOffset());
